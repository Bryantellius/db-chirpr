...
--
-- Dumping events for database 'chirpr'
--

--
-- Dumping routines for database 'chirpr'
--
/*!50003 DROP PROCEDURE IF EXISTS `spUserMentions` */;
...
BEGIN
SELECT
c.id, u.name, c.content, c._created as time
FROM mentions m
